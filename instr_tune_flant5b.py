# Flan version of LongT5 instruction tuning script
...
from transformers import AutoTokenizer, AutoModelForSeq2SeqLM, AutoConfig, DataCollatorForSeq2Seq, Seq2SeqTrainingArguments, Seq2SeqTrainer, LongT5Config, LongT5ForConditionalGeneration
...
def main(args):
    ...
    def preprocess_function(examples):
        ...
        # inputs = [truncate_instruction(doc+args.suffix) for doc in examples['instruction']]
    ...
    if args.optimizer=="adafactor":
        ...
        training_args = Seq2SeqTrainingArguments(
            ...
            optim="adafactor",
            adafactor=True,
            # max_steps=1,  # don't use if use num_train_epochs
